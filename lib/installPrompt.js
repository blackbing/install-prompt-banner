(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["installPrompt"] = factory();
	else
		root["installPrompt"] = factory();
...
function installPrompt() {
  ...
  this.checkPrompt = function () {
    ...
    if (force || count > _this.options.minimumPrompt) {
      _this.pop();
    }
  ...
  this.addCount = function () {
    var currentPVCount = _this._getCountFromStorage();

    currentPVCount += 1;
    try {
      localStorage.setItem(_this.options.promptKey, currentPVCount);
    } catch (e) {
      // do nothing
    }
